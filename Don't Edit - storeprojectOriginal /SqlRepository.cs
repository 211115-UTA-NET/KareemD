...
namespace StoreApp
{
    public class SqlRepository : IRepository
    {
        ...
        public void AddNewTransaction(string? buyer, string? item)
        {
            using SqlConnection connection = new(_connectionString);
            connection.Open();
            ...
            string cmdText = @"INSERT INTO Rps.Transaction (Timestamp, Player1, Player2, Player1Move, Player2Move)
            ...
            cmd.Parameters.AddWithValue("@timestamp", Transaction.Date);
            cmd.Parameters.AddWithValue("@p1", player1Id ?? (object)DBNull.Value);
            cmd.Parameters.AddWithValue("@p2", player2Id ?? (object)DBNull.Value);
            cmd.Parameters.AddWithValue("@p1move", Transaction.Player1.ToString());
            cmd.Parameters.AddWithValue("@p2move", Transaction.Player2.ToString());
        ...
        public int EnsurePlayerExistsAndGetId(SqlConnection connection, string name)
        {
            ...
            // inside the INSERT that inserts the Transaction
